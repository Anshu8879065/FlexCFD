...
{
public:
  void SetWrapper(std::function<void(NativeReal*, NativeReal*)>* cwp)
  {
    m_funcPass = cwp;
  }
...
public:
  auto operator()(std::array<itertools::IterState<NativeInt>, Dims> const& iterState,
    std::size_t minChangeLevel) -> bool
  {
