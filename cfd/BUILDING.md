...
Here are the steps for installing the dependencies:

```sh
conan create external/petsc/conanfile.py \
    --build=missing \
...
* Package name: `flexcfd`
* Target name: `flexcfd::flexcfd`

Example usage:

```cmake
find_package(flexcfd REQUIRED)
